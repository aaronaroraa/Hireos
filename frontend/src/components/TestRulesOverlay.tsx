        ...
        <AnimatePresence>
            {isOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    ...
                    >
                        <div className="bg-gradient-to-r from-slate-900 to-indigo-950 p-8 text-center border-b border-indigo-500/20">
                            ...
                            <p className="text-indigo-200 text-sm">Welcome, {candidateName}. This assessment environment is strictly proctored.</p>
                        </div>
                        ...
                        <div className="p-8">
                            ...
                            <div className="bg-indigo-50 rounded-2xl p-5 border border-indigo-100 flex items-start space-x-4 mb-8">
                                <div className="p-2 bg-indigo-600 rounded-lg text-white font-bold text-xs uppercase tracking-wider">Note</div>
                            ...
                            <button 
                                onClick={onAccept}
                                className="w-full py-4 bg-slate-900 hover:bg-slate-800 text-white rounded-2xl font-bold flex items-center justify-center space-x-3 transition-all transform hover:scale-[1.01] active:scale-95 shadow-xl"
                            >
