    ...
    return (
        <div>
            ...
            <div className="flex items-center justify-between mb-8">
                <div>
                    <h1 className="text-4xl font-display font-black text-gray-900 tracking-tight text-glow">
                        Jobs & Requisitions
                    </h1>
            ...
            <div className="flex items-center space-x-4 mb-6">
                <span className="bg-gray-50 text-gray-700 px-3 py-1 rounded-full text-sm font-semibold border border-gray-100">
            ...
            {filteredJobs.length === 0 ? (
                ...
                >
                    ...
                    <p className="text-gray-500 mb-6">Create your first job requisition to start hiring.</p>
                    <button
                        onClick={() => setIsModalOpen(true)}
                    ...
                    {filteredJobs.map((job, i) => (
                        <motion.div
                            ...
                            className={`card-3d cursor-pointer ${selectedJob?.id === job.id
                                ? 'border-gray-200 ring-1 ring-black bg-white'
                                : 'hover:bg-white'
                                }`}
                        >
                            <div className="flex items-start justify-between mb-4">
                                <div className="p-2.5 bg-black rounded-xl border border-gray-200 shadow-sm">
                            ...
                            <div className="flex flex-wrap gap-1.5 mb-4">
                                {(job.skills_required || []).slice(0, 4).map((skill, si) => (
                                    <span key={si} className="text-xs bg-gray-100 text-gray-600 px-2.5 py-1 rounded-full font-medium">
                                        {skill}
                                    </span>
                                ))}
                ...
                {isModalOpen && (
                    ...
                    >
                        <motion.div
                            ...
                            className="relative card-3d bg-white w-full max-w-lg overflow-hidden flex flex-col p-0 border border-white/40"
                        >
                            <div className="flex items-center justify-between p-6 bg-white border-b border-white">
                                <h2 className="text-2xl font-display font-bold text-gray-900">Create New Job</h2>
                                <button onClick={() => setIsModalOpen(false)} className="p-2 hover:bg-gray-100/50 rounded-lg transition-colors">
                            ...
                            <div className="p-6 space-y-4">
                                ...
                                <button
                                    ...
                                    className="w-full py-3.5 bg-gray-100 text-black border border-gray-200 rounded-xl hover:bg-gray-200 transition-all font-medium disabled:opacity-50 shadow-sm"
                                >
                                ...
                                {newDescription && (
                                    <div>
                                        ...
                                        <textarea
                                            ...
                                            rows={8}
                                            className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-gray-500 focus:border-gray-500 outline-none text-sm"
                                        />
                                    </div>
                                )}
                                <button
