...
export const CandidateAssessment: React.FC = () => {
    ...
    if (isDisqualified) {
        return (
            <div className="min-h-screen bg-slate-900 flex items-center justify-center px-4 overflow-hidden relative">
                ...
                <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="bg-white rounded-[2.5rem] p-12 border border-white/20 max-w-xl w-full text-center relative z-10">
                    <div className="w-24 h-24 bg-rose-500 rounded-3xl flex items-center justify-center mx-auto mb-8 rotate-12">
    ...
    if (error && !assessment) {
        return (
            <div className="min-h-screen bg-slate-50 flex items-center justify-center px-4">
                <div className="bg-white rounded-2xl p-8 border border-red-100 max-w-md text-center">
    ...
    if (result) {
        return (
            <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-gray-50 flex items-center justify-center px-4 py-12">
                <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="bg-white rounded-3xl p-10 border border-slate-200/60 max-w-lg w-full text-center">
                    <div className="w-20 h-20 bg-gradient-to-br from-emerald-400 to-green-600 rounded-full flex items-center justify-center mx-auto mb-6"><CheckCircle2 className="w-10 h-10 text-white" /></div>
                    ...
                    <div className="bg-black rounded-2xl p-6 mb-6 border border-gray-100">
                        <p className="text-sm font-medium text-gray-600 mb-2">Your Score</p>
                        <p className="text-5xl font-bold text-gray-900">{result.score}<span className="text-2xl text-gray-400">/100</span></p>
                    </div>
                    {result.feedback && (
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-gray-50 select-none">
            <TestRulesOverlay 
                isOpen={isRulesOpen} 
            ...
            <div className="bg-white border-b border-slate-200 shadow-sm sticky top-0 z-40">
                <div className="max-w-5xl mx-auto px-6 py-4 flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                        ...
                        <span className="text-lg font-bold text-slate-900">Recruitment OS — <span className="text-gray-600">SECURE_MODE</span></span>
                    </div>
            ...
            <AnimatePresence>
                {lastViolation && (
                    ...
                    >
                        <div className="bg-rose-600 text-white p-4 rounded-2xl flex items-center space-x-4 border-2 border-rose-400">
                            <div className="bg-white p-2 rounded-full"><ShieldAlert className="w-6 h-6" /></div>
                            <div>
                ...
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
                    ...
                    <div className="grid grid-cols-3 gap-6">
                        <div className="col-span-1 space-y-4">
                            <div className="bg-white rounded-2xl border border-slate-200/60 p-5 shadow-sm border-l-4 border-l-gray-500">
                            ...
                            <div className="bg-white rounded-2xl border border-slate-200/60 p-5 shadow-sm">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {assessment?.skills.map(s => (
                                        <span key={s} className="px-2.5 py-1 bg-gray-50 text-gray-700 text-xs font-bold rounded-lg border border-gray-100">{s}</span>
                                    ))}
                                </div>
                            </div>

                            <div className="bg-gray-950 p-5 rounded-2xl text-white shadow-gray-900/10">
                        ...
                        <div className="col-span-2 space-y-4">
                            <div className="bg-white rounded-[2rem] border border-slate-200 overflow-hidden">
                                <div className="bg-slate-900 px-5 py-4 flex items-center justify-between">
                                    ...
                                    <div className="flex items-center space-x-2"><div className="w-2 h-2 bg-gray-500 rounded-full animate-pulse" /><span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Live Editor</span></div>
                                </div>
                                <textarea
                                    value={code}
                                    onChange={(e) => setCode(e.target.value)}
                                    placeholder="# Write your solution here...&#10;&#10;def solve():&#10;    pass"
                                    className="w-full h-96 px-6 py-6 font-mono text-base bg-slate-950 text-gray-300 resize-none outline-none placeholder-slate-700 leading-relaxed"
                                    spellCheck={false}
                                />
                            </div>
                            ...
                            <motion.button
                                ...
                                className="w-full py-4 bg-slate-900 text-white rounded-[1.5rem] font-bold text-lg hover:bg-slate-800 disabled:bg-slate-300 disabled:cursor-not-allowed transition-all flex items-center justify-center space-x-3"
